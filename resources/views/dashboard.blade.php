                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <span class="isolate inline-flex rounded-md shadow-sm">
                      <a href="{{route('dashboard', ['score' => 'excellent', 'filter' => true])}}"
                              class="inline-flex items-center rounded-l-md border border-gray-300 bg-emerald-50 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"> Excelente </a>
                      <a href="{{route('dashboard', ['score' => 'regular', 'filter' => true])}}"
                              class="inline-flex items-center border border-gray-300 bg-amber-50 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"> Regular </a>
                      <a href="{{route('dashboard', ['score' => 'bad', 'filter' => true])}}"
                              class="inline-flex items-center rounded-r-md border border-gray-300 bg-red-50 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">Mal</a>
                    </span>
                    <div class="inline-flex rounded-md shadow-sm mr-5">
                        <div class="mt-1">
                            <form action="{{route('dashboard')}}" class="inline-flex" method="GET">
                                ...
                                <input type="submit" class="inline-flex items-center rounded-r-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                            </form>
                        </div>
                    </div>
                    @if($filters)
